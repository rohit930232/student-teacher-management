...
@WebServlet("/admin/attendance/teacher/view")
public class AdminTeacherAttViewServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            Map<String, Object> data = dao.getTeacherAttendanceByMonth(id, month);
