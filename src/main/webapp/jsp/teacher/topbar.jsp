...
<%
    ...
    String _tInit  = (_tName != null && _tName.length() > 0) ? String.valueOf(_tName.charAt(0)).toUpperCase() : "T";
...
<header class="topbar">
    ...
    <div class="topbar-right">
        <a href="<%=request.getContextPath()%>/teacher/notifications" class="icon-btn" title="Notifications">
            <i class="fas fa-bell"></i>
        </a>
        <a href="<%=request.getContextPath()%>/teacher/profile" class="topbar-profile-link">
