...
<%
    ...
    if (redirectUrl  == null) redirectUrl  = request.getContextPath() + "/admin/dashboard";
%>
<!DOCTYPE html>
<html>
<head>
...
<div class="exception-page">
    <div class="exception-card admin-theme">
        ...
        <div class="exception-actions">
            ...
            <a href="<%=request.getContextPath()%>/admin/dashboard" class="ex-btn ex-btn-secondary">
