    ...
    <div class="main">
        ...
        <div class="page-body">
            <div class="page-container">
                <h2 class="page-title"><i class="fas fa-chart-bar"></i> Result — Select Class</h2>
                <div class="class-grid">
                    ...
                    %>
                    <a href="<%=request.getContextPath()%>/admin/result/class?classId=<%= c.get("class_id") %>&className=<%= c.get("class_name") %>" class="class-card">
