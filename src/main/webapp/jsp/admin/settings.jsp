...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/admin/settings.css">
        ...
        <div class="page-body">
            ...
            <div class="settings-layout">
                ...
                <div class="settings-card">
                    ...
                    <div class="settings-card-body">
                        <div class="toggle-row"><span>Student Activity Alerts</span><label class="toggle-switch"><input type="checkbox" checked><span class="toggle-slider"></span></label></div>
                        <div class="toggle-row"><span>Teacher Activity Alerts</span><label class="toggle-switch"><input type="checkbox" checked><span class="toggle-slider"></span></label></div>
                        <div class="toggle-row"><span>Payment Notifications</span><label class="toggle-switch"><input type="checkbox" checked><span class="toggle-slider"></span></label></div>
                        <div class="toggle-row"><span>Exam Notifications</span><label class="toggle-switch"><input type="checkbox"><span class="toggle-slider"></span></label></div>
                    </div>
                </div>
                ...
                <div class="settings-card">
                    ...
                    <div class="settings-card-body">
                        <div class="privacy-item" onclick="togglePrivacy(this)"><div class="privacy-info"><h4>Admin Profile Visibility</h4><p>Control who can see admin info</p></div><i class="fas fa-chevron-right"></i></div>
                        <div class="privacy-item" onclick="togglePrivacy(this)"><div class="privacy-info"><h4>Data Export</h4><p>Manage data export settings</p></div><i class="fas fa-chevron-right"></i></div>
                        <div class="privacy-item" onclick="togglePrivacy(this)"><div class="privacy-info"><h4>Login History</h4><p>View recent login activity</p></div><i class="fas fa-chevron-right"></i></div>
                    </div>
                </div>
                        ...
                        <div class="security-section">
                            ...
                            <form action="<%=request.getContextPath()%>/Admin/Profile" method="post">
                                ...
                                <div class="form-grid-3">
                                    <div class="form-field"><label>Current Password</label><input type="password" name="oldPassword" placeholder="Current password" required></div>
                                    <div class="form-field"><label>New Password</label><input type="password" name="newPassword" id="newPass" placeholder="New password" required></div>
                                    <div class="form-field"><label>Confirm Password</label><input type="password" id="confirmPass" placeholder="Confirm password" required><span id="passMsg" class="field-msg"></span></div>
                                </div>
