    ...
    <div class="main">
        ...
        <div class="page-body">
            <div class="page-container">
                <h2 class="page-title"><i class="fas fa-file-alt"></i> Exams — Select Class</h2>
                <div class="class-grid">
                    ...
                    %>
                    <a href="<%=request.getContextPath()%>/admin/exam/class?classId=<%= c.get("class_id") %>&className=<%= c.get("class_name") %>" class="class-card">
                        <div class="class-card-icon"><i class="fas fa-chalkboard"></i></div>
                        <div class="class-card-info">
                            <h3><%= c.get("class_name") %></h3>
                            <p><i class="fas fa-file-alt"></i> <%= c.get("exam_count") != null ? c.get("exam_count") : "0" %> Exams</p>
                        </div>
