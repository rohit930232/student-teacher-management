...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/student/onlineclass.css">
        ...
        <div class="page-body">
            ...
            <div class="class-grid">
                ...
                <div class="class-card upcoming">
                    ...
                    <div class="class-link-info"><i class="fas fa-link"></i> Link will be available when class starts</div>
                </div>
